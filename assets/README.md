...
Original creative assets and editable art sources are licensed under CC BY 4.0; Godot-native `.tres`, `.tscn`, and `.gd` project files are licensed under MIT. See the repository [license overview](../LICENSE.md) and the asset catalog's per-entry license column before reusing material.
