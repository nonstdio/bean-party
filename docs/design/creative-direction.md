...
The player should feel that they have entered a scrappy, absurd bean combat game where the rules suddenly became party games. The experience should be energetic, mischievous, readable, and a little ridiculous—not polished into a generic fantasy board game or a direct Mario Party imitation.

## Directional principles

- **Bean-first silhouettes.** Characters, costumes, props, and hazards should be simple and instantly distinguishable at party-game camera distance.
...
Before creating a common art kit, contributors should keep reference links outside the shipped assets, record the source and license for every imported asset, and share original source files where practical. A future art-direction decision should establish a palette, font licensing, icon style, character proportions, camera conventions, and UI kit.

Until that decision exists, a minigame proposal should include a short art note: the setting, the player silhouettes, the critical gameplay colors, and why it fits this direction.

## Content guardrails

- Do not use extracted game files, screenshots as textures, ripped audio, or logos.
- Do not portray a specific Bean Battles character or reproduce a known map or interface.
- Avoid visual clutter that hides timing windows, team identity, or player position.
- Give all gameplay-critical information a non-color signal as well: shape, icon, label, pattern, or motion.
