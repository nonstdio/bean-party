...
The initial compatibility target is 2–4 local players using a shared screen and controllers or keyboard. Online play, more players, and asynchronous modes may follow, but should not complicate the first vertical slice.
